...
def ReshapeData(set0, set1, set2, set3, set4, set5, set6, set7, set8, set10, set11, set12, set13, set14, set15, set16, set17, set18, set19,
                set20, set21, set22, set23, set24, set25, set26, set27): #set28  #, set29):
    X = np.zeros((28000, 5*2*3), dtype = 'f') # normally 20000
    y = np.zeros((28000, 1), dtype = 'f')
    for row in range(0,1000):
        ...
        # Assembling the trainy/testy for three sets per digit
        #except 3, which only gets 1 because it's confused
        y[row,          0] = 0
        y[(row + 1000), 0] = 0
        y[(row + 2000), 0] = 0
        y[(row + 3000), 0] = 1
        ...
        # Assembling the trainy/testy for 2 sets per digit except 3
        # y[row,          0] = 0
        # y[(row + 1000), 0] = 0
        # y[(row + 2000), 0] = 1
        # y[(row + 3000), 0] = 1
...
# 1 and 2 have only one dataset; the others all have two
# trainX, trainy = ReshapeData(train0_a, train0_b, train1_a, train2_a, train3_a, train3_b, train4_a, train4_b, train5_a, train5_b, train6_a, train6_b, train7_a, train7_b, train8_a, train8_b, train9_a, train9_b)
# testX, testy = ReshapeData(test0_a, test0_b, test1_a, test2_a, test3_a, test3_b, test4_a, test4_b, test5_a, test5_b, test6_a, test6_b, test7_a, test7_b, test8_a, test8_b, test9_a, test9_b)
#

# for when each digit has 3 sets
trainX, trainy = ReshapeData(train0_a, train0_b, train0_c,
                             train1_a, train1_b, train1_c,
                             train2_a, train2_b, train2_c,
                             #train3_a,
                             train4_a, train4_b, train4_c,
                             train5_a, train5_b, train5_c,
                             train6_a, train6_b, train6_c,
                             train7_a, train7_b, train7_c,
                             train8_a, train8_b, train8_c,
                             train9_a, train9_b, train9_c)

testX, testy = ReshapeData(test0_a, test0_b, test0_c,
                           test1_a, test1_b, test1_c,
                           test2_a, test2_b, test2_c,
                           #test3_a,
                           test4_a, test4_b, test4_c,
                           test5_a, test5_b, test5_c,
                           test6_a, test6_b, test6_c,
                           test7_a, test7_b, test7_c,
                           test8_a, test8_b, test8_c,
                           test9_a, test9_b, test9_c)

# for when each digit except for 3 gets 3 sets, because 3 is being a little shit


knn.Use_K_Of(175) # originally 15
...
for row in range(0,28000): # normally 0:20000
...
userDataDir = 'C:\Users\Haley\Desktop\School Papers\HCI CS228 Jr\LeapDeveloperKit_3.2.1_win\LeapDeveloperKit_3.2.1+45911_win\LeapSDK\lib\CS228\Del6\userData\classifier_30sets_no3.p'
